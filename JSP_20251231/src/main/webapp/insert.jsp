...
<div class="conatainer mt-5">
    <h3 class="text-center">Statement로 데이터 입력</h3>
            ...
            <div class="col-sm-4 mx-auto">
                <form action="insertProcess.jsp" method="post">
                    <div class="mt-3">
                        ...
                        <input type="text" class="form-control" id="user-id" name="userId" placeholder="사용자ID를 입력해주세요">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="form-control" id="user-name" name="userName" placeholder="사용자이름을 입력해주세요">
                    </div>
