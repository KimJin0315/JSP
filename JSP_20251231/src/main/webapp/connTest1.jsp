...
<div class="container mt-5">
    ...
    <%
        // statement : 데이터베이스에 접속하여 SQL 쿼리문을 생성하는 클래스
...
//            Connection 객체를 사용하여 SQL문 실행을 위한 Statement 클래스 타입의 객체 생성
            stmt = conn.createStatement();
//            Statement 타입의 객체를 사용하여 SQL문을 실행하고 그 결괄르 ResultSet 클래스 타입의 객체로 받아옴
...
//            데이터베이스 사용 후 접속 종료
//            데이터베이스 사용의 반대 순서로 리소스를 해제해야 함, ResultSet -> Statement -> Connection
            if (rs != null) {rs.close();}
