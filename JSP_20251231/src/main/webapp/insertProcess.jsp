...
//        insert를 위한 SQL문 생성
//        주의사항
//        1. 사용자가 쿼리문을 알아보기 쉽도록 여러 줄로 입력하는 것을 궍장
...
//        createStatement() : Connection 객체를 통해서 Statement 객체를 생성하는 명렁어
...
<div class="container mt-5">
    <h3 class="text-center">Statement로 insert 진행하기</h3>
