package jsp_20251229.jsp_20251229;
...
//    네번째 : 쿠키가 클라이언트에 보관되는 시간(이 시간이 지나면 쿠키 자동 삭제)
    public static void makeCookie(HttpServletResponse response, String cookieName, String cookieValue, int cookieTime) {
        ...
        response.addCookie(cookie); // 응답 객체인 response에 쿠키 정보 저장
    }

//    쿠키 내용 읽기
//    첫번째 : JSP의 request 내장 객체를 받음
//    두번째 : 저장된 쿠키의 이름
...
//        응답 객체인 response를 전달하고, 삭제할 쿠키명과 보관시간을 0으로 설정하여 삭제
