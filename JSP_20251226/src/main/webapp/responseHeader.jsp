...
//    getTime()을 사용하여 실제 자아의 Date클래스 타입의 데이터로 변환
...
<head>
    ...
    <link href=java.text.SimpleDateFormat"https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css"
...
//           동일한 헤더명으로 여러 개의 데이터가 저장되어 있을 경우, getHeader()를 사용하여 검색되는 첫번째 데이터만 가져옴
